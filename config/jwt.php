...
return [
    ...
    */
    ...
    | authentication models e.g. `App\BranchUserModel` & `App\OtherPerson`, then we
    ...
    */
     ...
     * ------------------------------------------------------------------------
     *
     * 当用户jwt验证时，获取用户数据来判断和控制用户jwt时效，
     * 看守器索引就是看守器昵称（guards on keys is guard name）。
     */
    'guards' => [
        // 默认看守器，可修改
        'default' => [
            'provider' => '\app\model\User',
        ],
